...
Desc: takes a user part no, checks for lowercase and changes to uppercase
In: string user partno.
Out: ptr to char[]
...
Desc: compares the user's entry to the partnumber that is currently stored
In: ptr to array that holds csytle string from user, string of the datapart
Out: bool to indicate match
